      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section class="p-h-video-box" id="videoPlay">
            <img height="357px" :src="courseWebVo.cover" :alt="courseWebVo.subjectLevelTwo" class="dis c-v-pic">
          </section>
        </article>
                        ...
                        <ul>
                          ...
                          <li class="lh-menu-stair" v-for="chapter in chapterList" :key="chapter.id">
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              <li class="lh-menu-second ml30" v-for="children in chapter.children" :key="children.id">
                                <a :href="'/player/'+children.videoSourceId" :title="children.title">
                                  <span class="fr">
